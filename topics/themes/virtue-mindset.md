...
```mermaid
graph TD
    VIRTUE["Virtue, Mindset & Spirituality"]

    VIRTUE --> EGO["Ego, Humility & Self-Worth"]
    VIRTUE --> COMMIT["Disciplined Love & Empathy"]
    VIRTUE --> AWARE["Self-Awareness & Blind Spots"]

    EGO --> D1["[[topics/documents/humility-is-not-low-self-esteem|Humility is Not Low Self-Esteem]]"]
    EGO --> D2["[[topics/documents/the-charisma-trap|The Charisma Trap & Smartest in Room]]"]
    COMMIT --> D3["[[topics/documents/understanding-vs-feeling-love|Understanding vs. Feeling Love]]"]
    AWARE --> D4["[[topics/documents/alone-but-not-lonely|Alone, But Not Lonely]]"]
    AWARE --> D5["[[topics/documents/therapy-preventive-maintenance|Therapy as Preventive Maintenance]]"]
```
